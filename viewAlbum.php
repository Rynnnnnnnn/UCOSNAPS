...
<body>
    ...
    <div class="albumActions" style="margin-bottom: 20px;">
        <form action="core/handleForms.php" method="POST" style="display: inline;">
            ...
            <input type="submit" name="deleteAlbumBtn" value="Delete Album" onclick="return confirm('Are you sure you want to delete this album? This action cannot be undone.')">
        </form>

        <form action="core/handleForms.php" method="POST" style="display: inline;">
            <input type="hidden" name="album_id" value="<?php echo $album_id; ?>">
            <input type="text" name="new_album_name" placeholder="New Album Name" required>
            <input type="submit" name="editAlbumBtn" value="Edit Album">
        </form>
    </div>
